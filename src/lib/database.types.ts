  ...
  public: {
    Tables: {
      ...
      character_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "character_categories_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
      ...
      character_sets: {
        ...
        Relationships: [
          {
            foreignKeyName: "character_sets_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "character_categories"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "character_sets_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "character_categories_with_counts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "character_sets_category_id_fkey"
      ...
      characters: {
        Row: {
          ...
          stroke_order_image: string | null
          updated_at: string
        }
        Insert: {
          character: string
        ...
        Relationships: [
          {
            foreignKeyName: "characters_character_set_id_fkey"
            columns: ["character_set_id"]
            isOneToOne: false
            referencedRelation: "character_details"
          ...
          },
          {
            ...
            columns: ["character_set_id"]
            isOneToOne: false
            referencedRelation: "character_sets"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "characters_character_set_id_fkey"
            columns: ["character_set_id"]
            isOneToOne: false
            referencedRelation: "character_sets_with_counts"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      flashcards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "flashcards_character_id_fkey"
      ...
      user_character_progress: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_character_progress_character_id_fkey"
            columns: ["character_id"]
            isOneToOne: false
            referencedRelation: "character_details"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "user_character_progress_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Views: {
      character_categories_with_counts: {
        Row: {
